...
exports.adminAnalyticsQuerySchema = exports.trackPageViewSchema = void 0;
const zod_1 = require("zod");
exports.trackPageViewSchema = zod_1.z
    .object({
    sessionId: zod_1.z
        .string({
    ...
    pathname: zod_1.z
        ...
        .refine((val) => val.startsWith('/') && !val.includes('://') && !val.includes('\0') && !val.startsWith('//'), {
    ...
    .strict();
exports.adminAnalyticsQuerySchema = zod_1.z
    .object({
    period: zod_1.z.enum(['today', '7d', '30d', 'all']).default('7d'),
    startDate: zod_1.z
        .string()
