...
exports.renderVisaApplicantConfirmation = renderVisaApplicantConfirmation;
const base_layout_1 = require("./base.layout");
function renderVisaApplicantConfirmation(data) {
    ...
    <div style="margin-bottom: 24px;">
      <h2 style="margin: 0 0 12px 0; font-size: 18px; color: #0B192C; font-weight: 700;">
        Dear ${(0, base_layout_1.escapeHtml)(data.fullName)},
      </h2>
      <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #334155;">
        Thank you for contacting <strong>Cityline Consultancy</strong>. We have received your visa enquiry for <strong>${(0, base_layout_1.escapeHtml)(data.serviceTitle)}</strong> and our advisory team has initiated preliminary document verification.
      </p>
    </div>
