...
exports.renderBusinessEnquiryConfirmation = renderBusinessEnquiryConfirmation;
const base_layout_1 = require("./base.layout");
function renderBusinessEnquiryConfirmation(data) {
    ...
    <div style="margin-bottom: 24px;">
      ...
      <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #334155;">
        Thank you for reaching out to <strong>Cityline Consultancy</strong>. We have successfully received your enquiry regarding <strong>${(0, base_layout_1.escapeHtml)(data.service)}</strong>.
      </p>
