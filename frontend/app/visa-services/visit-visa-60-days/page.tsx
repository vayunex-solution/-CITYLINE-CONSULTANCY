...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/visa-services/visit-visa-60-days/',
  },
  openGraph: {
    title: '60-Day Visit Visa UAE Assistance | Cityline Consultancy',
    description:
      'Extended stay 60-day UAE visit visa application support. Ideal for interviews and business networking.',
    url: '/visa-services/visit-visa-60-days/',
  },
};
    ...
    <div className="page-wrapper">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: '60-Day Visit Visa', url: '/visa-services/visit-visa-60-days/' },
        ]}
      />
      <ServiceJsonLd
        name="60-Day Visit Visa UAE Assistance"
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ marginTop: 'var(--space-4)' }}>
            <div style={{ display: 'inline-flex', gap: 'var(--space-2)', flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              <Badge variant="slate">Extended Exploration Stay</Badge>
              <Badge variant="outline">Interview & Networking</Badge>
            </div>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-4)', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a
                href="https://wa.me/971501234567?text=Hello%20Cityline,%20I%20am%20inquiring%20about%20the%2060-Day%20UAE%20Visit%20Visa."
                target="_blank"
